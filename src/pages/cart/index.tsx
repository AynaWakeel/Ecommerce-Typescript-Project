            ...
            <div className=' px-6 md:px-14 xl:px-36 py-8 lg:py-24 flex flex-col xl:flex-row justify-between items-start gap-5'>
                    ...
                    <table className='min-w-[600px] w-full border-separate border-spacing-y-3 table-auto'>
                        ...
                        <tbody className='pt-4'>
                            <tr>
                                ...
                                <td>
                                <span className='text-sm lg:text-base font-poppins font-normal text-[#9F9F9F]'>Rs. 250,000.00</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <p className='text-sm lg:text-base font-poppins font-normal text-black'>Rs. 250,000.00</p>
                                </td>
                                <td>
                                    <img src={del} alt='del' />
                                </td>
                ...
                <div className='bg-[#FFF9E5] py-8 px-6 xl:px-10 w-full md:w-1/2  xl:w-1/3 text-center mt-3'>
                    ...
                    <div className='flex justify-between pb-4'>
                        ...
                        <p className='text-sm lg:text-base font-poppins font-normal text-black text-justify'>Rs. 250,000.00</p>
                    </div>
                    <div className='flex justify-between pb-6'>
                        <h4 className='text-sm lg:text-base font-poppins font-normal text-black text-justify'>Total</h4>
                        <p className='text-lg lg:text-xl font-poppins font-medium text-[#B88E2F] text-justify'>Rs. 250,000.00</p>
                    </div>
                    <button className='text-base lg:text-xl font-poppins font-normal text-black rounded-xl border-[1px] border-black h-12 w-36' onClick={()=>navigate('/checkout')}>Check Out</button>
